...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git_auth_status,
            commands::git_connect_provider,
            commands::git_reconnect_provider,
            commands::git_connect_provider_for_url,
            commands::git_https_url_for_remote,
            commands::git_convert_remote_to_https,
