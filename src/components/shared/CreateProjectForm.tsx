    ...
    return (
      <div className="flex flex-col gap-2">
        <input
          ...
          autoFocus
          className="workspace-input w-full rounded-xl px-3 py-2 text-sm text-neutral-200 placeholder-neutral-600 outline-none focus:border-[var(--accent)]"
        />
        <input
          type="text"
          value={description}
        ...
        <select
          ...
          className="workspace-input w-full rounded-xl px-3 py-2 text-sm text-neutral-200 outline-none focus:border-[var(--accent)]"
        >
          {templates.length === 0 && (
        ...
        <div className="space-y-2">
          {templates.map((t) => (
            <button
              ...
              className="flex w-full items-center gap-3 rounded-2xl border px-4 py-3 text-left transition-colors workspace-subsection text-neutral-400"
              style={selectedTemplate === t.name ? { borderColor: "var(--accent)", background: "var(--accent-soft)", color: "var(--text)" } : undefined}
            >
              <span
                className="h-3.5 w-3.5 rounded-full border-2 flex-shrink-0"
                style={selectedTemplate === t.name ? { borderColor: "var(--accent)", background: "var(--accent)" } : { borderColor: "var(--border)" }}
              />
